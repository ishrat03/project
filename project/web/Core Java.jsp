<%-- 
    Document   : java-home
    Created on : Apr 19, 2017, 12:13:15 AM
    Author     : Mohd Ishrat
--%>
...
<p>This reference will take you through simple and practical approaches while learning Java Programming language.</p>
</div>
<h1>Audience</h1>
...
<h1>Execute Java Online</h1>
<p>For most of the examples given in this tutorial, you will find a ‘Try it’ option, which you can use to execute your Java programs at the spot and enjoy your learning.</p>
...
<div class="pre-btn">
    <a href="Core Java.jsp">Previous Page</a>
</div>

<div class="nxt-btn">
<a href="java-overview.jsp">Next Page</a>
</div>
