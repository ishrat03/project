...
public final class C_002dstructure_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Structures in C</title>\n");
      out.write("     <style>\n");
      out.write("        .cc {\n");
      ...
      out.write("                    <center>\n");
      out.write("                        <h1>Structures in C</h1>\n");
      out.write("                    </center>\n");
      out.write("      <p>Here, the c contains 6 members: Four 1 bit flags f1..f3, a 4-bit type and a 9-bit my_int.</p>\n");
      out.write("<p>C automatically packs the above bit fields as compactly as possible, provided that the maximum length of the field is less than or equal to the integer word length of the computer. If this is not the case, then some compilers may allow memory overlap for the fields while others would store the next field in the next word.</p>\n");
      out.write("<hr />\n");
